...
namespace PawMapLoader.Res.GUI
{
    ...
    {
        public static Interpreter consoleInterpreter;

        public static bool ConsoleShown = false;

        public static Rect ConsoleRect = new Rect(Screen.width * .6f, Screen.height * .04f, Screen.width * .4f,
            Screen.height * .6f);
        ...
        public static Rect LogRect = new Rect(WindowPadding, WindowPadding, ConsoleRect.width - 2 * WindowPadding,
            Screen.height - 2 * WindowPadding - CommandBarHeight);
        ...
        public static void Register()
        {
            ...
            Store.Udevnt += Update;
            consoleInterpreter = new Interpreter();
        }
        ...
        public static void GUIUpdate()
        {
            ...
            ConsoleRect = UnityEngine.GUI.Window(ConsoleID, ConsoleRect, (UnityEngine.GUI.WindowFunction)DrawConsole,
                ConsoleName);
        }

        public static void DrawConsole(int wid)
        {
            // Days wasted fixing crash: 3
            ScrollPos = UnityEngine.GUI.BeginScrollView(LogRect, ScrollPos, LogContentRect);
